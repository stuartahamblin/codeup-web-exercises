console.log("EXTRA OBJECT CHALLENGES start");
...
// // getAverageSalesPerEmployee() should return the average units sold per employee
    ...
    // ANSWER
    // function getEmployeeCount(array) {
    //     return array.employees.length;
    // }
    // console.log(getEmployeeCount(salesReport));

    // ANSWER
    // function getTotalNumberOfSales(array) {
    //     var count = 0;
    //     for (i = 0; i < array.employees.length; i++) {
    //         count += array.employees[i].salesUnits;
    //     }
    //     return count;
    // }
    ...
    // ANSWER
    // function getAverageSalesPerEmployee(array) {
    //     var count = 0;
    //     for (i = 0; i < array.employees.length; i++) {
    //         count += array.employees[i].salesUnits;
    //     }
    //     count = count / array.employees.length;
    //     return count;
    // }
